...
//    (upper bound)
fun <T : Any> logger(clazz: KClass<T>) = LoggerFactory.getLogger(clazz.java)
...
inline fun <reified T : Any> logger2() = LoggerFactory.getLogger(T::class.java)

//type arguments can be ommitted (call-site) if
// the context makes it clear and the compiler can infer it
inline fun <reified T : Any> T.logger3() = LoggerFactory.getLogger(T::class.java)
